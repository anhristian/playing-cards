...
public class Trick {
  ...
  private void organize() {
    //now deck has 52 card not shuffled  with the word new.
    Deck deck = new Deck();
    ...
    while (!cards.isEmpty()) {
      //here 0 is the index position in the cards.
      Card selector = cards.remove(0);
      if (selector.getSuit().getColor() == Color.RED) {
        //0 here show the next card that we don't see.
  ...
  public static void main(String[] args) {
    //trick is an instance of the Trick class.
